...
import { InvestmentCalculator } from '@/components/project-details/InvestmentCalculator'
import { RoiForecastSection } from '@/components/project-details/RoiForecastSection'
