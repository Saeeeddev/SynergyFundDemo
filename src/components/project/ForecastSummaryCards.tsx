...
import { TrendingUp, Percent, Clock, DollarSign } from 'lucide-react'
import { StatCard } from '@/components/ui/StatCard'
import { formatTomanCompact } from '@/lib/utils/currency'
import { formatPercent, formatNumber } from '@/lib/utils/numbers'
  ...
  return (
    <div className="grid grid-cols-2 gap-3 lg:grid-cols-4 lg:gap-4">
      ...
      <StatCard
        ...
        value={`${formatNumber(paybackYears, 1)} سال`}
        icon={<Clock size={20} />}
        role="energy"
      />
